...
function Timer() {
  ...
  var mergedConfig = (0, _objectSpread2.default)({}, defaultConfig, config);
  var onStart = mergedConfig.onStart,
      onStarted = mergedConfig.onStarted,
      onStop = mergedConfig.onStop,
      onStopped = mergedConfig.onStopped,
      onUpdate = mergedConfig.onUpdate;
  (0, _keys.default)(mergedConfig).forEach(function (k) {
    _this[k] = mergedConfig[k];
  });
  var duration = this.max - this.min;
  var tl = new _gsap.TimelineLite({
    paused: true
  });
  var initialProgress = (this.date - this.min) / duration;
  this.running = false;
  tl.timeScale(0);
  tl.fromTo(this, duration / 1000, {
    date: this.min
  }, {
    date: this.max,
  ...
  this.start = function () {
    ...
    _gsap.TweenLite.to(tl, _this.tweenDuration.up / 1000, {
      timeScale: _this.rate,
      onStart: onStart,
  ...
  this.stop = function () {
    ...
    _gsap.TweenLite.to(tl, _this.tweenDuration.down / 1000, {
      timeScale: 0,
      onStart: onStop,
  ...
  this.setDate = function (v) {
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        dontAnimate = _ref.dontAnimate;

    var progress = (+v - _this.min) / duration;
...
},{"@babel/runtime-corejs2/core-js/object/keys":"node_modules/@babel/runtime-corejs2/core-js/object/keys.js","@babel/runtime-corejs2/helpers/objectSpread":"node_modules/@babel/runtime-corejs2/helpers/objectSpread.js","gsap":"node_modules/gsap/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/Timer.82a6eab8.js.map