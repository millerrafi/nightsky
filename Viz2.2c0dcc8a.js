...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/three/makeRing.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = makeRing;
...
function makeRing(_ref) {
  var distance = _ref.distance,
      color = _ref.color,
      _ref$width = _ref.width,
      width = _ref$width === void 0 ? 0.5 * DEG : _ref$width,
      _ref$front = _ref.front,
      front = _ref$front === void 0 ? {} : _ref$front,
      _ref$back = _ref.back,
      back = _ref$back === void 0 ? {} : _ref$back;
  var obj = new THREE.Object3D();
  var frontMesh = new THREE.Mesh(new THREE.SphereGeometry(distance, 128, 2, 0, Math.PI * 2, Math.PI / 2 - width / 2, width), new THREE.MeshBasicMaterial((0, _objectSpread2.default)({
    color: color,
    side: THREE.FrontSide,
    opacity: 0.5,
    transparent: true
  }, front)));
  var backMesh = new THREE.Mesh(new THREE.SphereGeometry(distance, 128, 2, 0, Math.PI * 2, Math.PI / 2 - width / 2, width), new THREE.MeshBasicMaterial((0, _objectSpread2.default)({
    color: color,
    side: THREE.BackSide
  }, back)));
  obj.add(frontMesh);
...
},{"@babel/runtime-corejs2/helpers/objectSpread":"node_modules/@babel/runtime-corejs2/helpers/objectSpread.js","three":"node_modules/three/build/three.module.js"}],"js/three/Viz2.js":[function(require,module,exports) {
"use strict";
...
var _makeRing = _interopRequireDefault(require("./makeRing.js"));
...
function Viz(index) {
  ...
  var WIDTH = BCR.width;
  var HEIGHT = BCR.height; // Set some camera attributes.
  ...
  var sun = new THREE.Sprite(new THREE.SpriteMaterial({
    map: new THREE.TextureLoader().load(_images.default['sun.png']),
    depthWrite: false
  }));
  ...
  scene.add(northPole);
  var eclipticPlane = (0, _makeRing.default)({
    distance: _constants.EARTH_DISTANCE,
    width: 1 * _constants.DEG,
  ...
  var moonOrbit = (0, _makeRing.default)({
    distance: _constants.EARTH_DISTANCE,
  ...
  moonTilt.rotateOnWorldAxis(new THREE.Vector3(1, 0, 1).normalize(), 5.1 * _constants.DEG); // eclipticPlane.rotation.x = Math.PI / 2;
  ...
  scene.add(light);
  var graticule = (0, _graticule.default)(_constants.EARTH_DISTANCE, 0x666666, {
    material: {
      opacity: 0.1
    }
  });
  ...
  var equator = (0, _makeRing.default)({
    distance: _constants.EARTH_DISTANCE,
    width: 2 * _constants.DEG,
  ...
  require("_bundle_loader")(require.resolve('/js/three/starField.js')).then(function (_ref) {
    ...
    scene.add(makeStarField(_constants.EARTH_DISTANCE, {
      maxSize: 1,
      dot: true,
      // additive: true,
      ...
      fadePoint: function fadePoint(mag) {
        return Math.exp(-8 * (mag - 2));
      } // scalePoint: mag => 2
  ...
  return {
    update: function update(_ref2) {
      ...
      sun.position.z = _constants.EARTH_DISTANCE * Math.cos(sunLong); // pi/2 correction for shader texture

      earth.rotation.y = positions.Earth.rotationAngle * _constants.DEG + Math.PI * 0.5;
...
var b=require("node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.load([]).then(function(){require("js/three/Viz2.js");});
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js",0], null)
//# sourceMappingURL=/Viz2.2c0dcc8a.js.map